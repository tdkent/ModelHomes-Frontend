		...
		<>
			...
			<div className="content font-sans text-base flex flex-col gap-8">
				...
				<section>
					...
					<p>
						GGIEMH is an informational website. It does not provide user
						accounts, login functionality, or interactive features that collect
						personal information. By using this website, you agree to the terms
				...
				<section>
					...
					<p>
						...
						hosting providers, content delivery networks (CDNs), or DNS
				...
				<section>
					...
					<p>
						...
						completeness, accuracy, or timeliness of the information presented.
				...
				<section>
					...
					<p>
						...
						be modified, suspended, or permanently shut down at any time and for
				...
				<section>
					...
					<p>
						...
						informational purposes only and are offered “as is” without
					...
					<p>
						...
						or actions taken by visitors based on information or images
					...
					<p>
						...
						responsibility for any actions taken by visitors related to
						properties shown on the site.
					</p>
				</section>
				<section>
